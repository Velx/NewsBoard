...
class CommentSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        return Comment.objects.create(**validated_data, post_id=self.context["post_id"])
...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields = ["title", "link", "creation_date", "upvotes_amount", "author_name"]
        extra_kwargs = {"upvotes_amount": {"read_only": True}}
